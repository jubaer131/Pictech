...
const PowerfulFeature = () => {
    return (
        <div className='max-w-[1305px] mx-auto mt-28'>
            <h1 className='text-center lg:text-4xl font-bold mb-2'>Powerful Features That Set Us <br /> Apart and Ahead</h1>
            <p className='text-center'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum <br /> has been the industry's standard dummy text.</p>
            <div className='lg:flex justify-center items-center gap-28 mt-20'>
